...
export type PagefindModule = {
  ...
  // Rarely needed: Pagefind will be automatically initialized upon searching
  init: () => void;
  /**
   * Unload the active Pagefind, and also forget anything that was passed through pagefind.options(), resetting to the blank state after the script was first imported.
