...
import { plainTooltipStyle } from "./plain-tooltip.css";
...
export const PlainTooltip: Component<PlainTooltipProps> = (props) => {
  ...
  return (
    <div
      ...
      class={clsx(plainTooltipStyle, localProps.class)}
      {...otherProps}
      role="tooltip"
      style={{
